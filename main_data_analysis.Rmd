...
idxdf_basolo %>%
  ...
  labs(x = "Vancomycin-MiRIx", y = "") +
  theme_classic()
save_figure("figures/mirix_fig2a_left", width = 3.8, height = 1.5)
```
...
idxdf_sprockett %>%
  ...
  labs(x = "Metronidazole-MiRIx", y = "") +
  theme_classic() +
  theme(plot.margin = margin(l=20, t=5, r=5, b=5))
save_figure("figures/mirix_fig2b_left", width = 3.8, height = 2.5)
```
...
idxdf_cabral %>%
  ...
  labs(x = "Amoxicillin-MiRIx", y = "") +
  theme_classic() +
  theme(plot.margin = margin(l=14, t=5, r=5, b=5))
save_figure("figures/mirix_fig3a_left", width = 3.8, height = 1.5)
```
...
idxdf_boynton %>%
  ...
  labs(x = "Doxycycline-MiRIx", y = "") +
  theme_classic() +
  theme(
    strip.background = element_blank(),
    plot.margin = margin(l=30, t=5, r=5, b=5))
save_figure("figures/mirix_fig3b_left", width = 3.8, height = 5)
```
...
s_boynton %>%
  ...
  facet_grid(~ study_group) +
  labs(y = "Shannon diversity", x = "Doxycycline-MiRIx", color = "") +
  theme_bw() +
  theme(strip.background = element_blank())
...
save_figure("figures/mirix_fig2a_right", width = 3.8, height = 1.5)
```
...
cts_sprockett %>%
  ...
  theme(
    ...
    axis.ticks.y = element_blank(),
    plot.margin = margin(l = 10, r = 20, b = 6, t = 4))
save_figure("figures/mirix_fig2b_right", width = 3.8, height = 2.5)
```
...
cts_willmann %>%
  ...
  theme(
    ...
    axis.ticks.y = element_blank(),
    plot.margin = margin(l = 10, r = 20, b = 6, t = 4))
save_figure("figures/mirix_fig2c_right", width = 3.8, height = 2.5)
```
...
cts_cabral %>%
  ...
  theme(
    ...
    axis.ticks.y = element_blank(),
    plot.margin = margin(l = 10, r = 20, b = 6, t = 4))
save_figure("figures/mirix_fig3a_right", width = 3.8, height = 1.5)
```
...
cts_boynton %>%
  ...
  theme(
    ...
    plot.margin = margin(l = 10, r = 20, b = 6, t = 4),
    strip.background = element_blank())
save_figure("figures/mirix_fig3b_right", width = 3.8, height = 5)
```
